            ...
            <div class="card-body pt-3">
              ...
              ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Cheetah Net</div>
                  </div>
              ...
              ?></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php
              $role = $this->session->userdata('uphone');
              echo $role;
              ?></div>
                  </div>
              ...
              ?></div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form  id="edit-profile" method="POST" action="javascript:void(0)">
                    <div class="row mb-3">
              ...
              ?>">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        value="<?php $role = $this->session->userdata('email');echo $role;?>">
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form  id="change-password" method="POST" action="javascript:void(0)">
